...
export function ResidentLayout() {
  ...
  return (
    <div className="min-h-screen bg-surface-bg flex flex-col">
      {/* Top Header */}
      <header className="bg-surface-card border-b border-border-default px-lg py-md flex items-center justify-between sticky top-0 z-10">
      ...
      {/* Main Content */}
      <main className="flex-1 pb-24 px-lg py-lg max-w-2xl mx-auto w-full">
        <Outlet />
      </main>
